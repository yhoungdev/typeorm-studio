import type { InMemoryDataset } from "./adapters/in-memory";

export const sampleDataset: InMemoryDataset = {
  schema: {
    models: [
      {
        name: "User",
